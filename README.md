...
function CheckQuest() 
    ...
    if World1 then
        ...
        elseif MyLevel == 60 or MyLevel <= 74 then
            Mon = "Desert Bandit"
            LevelQuest = 1
            lucaxxQuest = "DesertQuest"
            lucaxxMon = "Desert Bandit"
        ...
        elseif MyLevel == 75 or MyLevel <= 89 then
            ...
            LevelQuest = 2
            lucaxxQuest = "DesertQuest"
            lucaxxMon = "Desert Officer"
            CFrameQuest = CFrame.new(894.488647, 5.14000702, 4392.43359, 0.819155693, -0, -0.573571265, 0, 1, -0, 0.573571265, 0, 0.819155693)
            CFrameMon = CFrame.new(1608.2822265625, 8.614224433898926, 4371.00732421875)
        elseif MyLevel == 90 or MyLevel <= 99 then
            Mon = "Snow Bandit"
            LevelQuest = 1
            lucaxxQuest = "SnowQuest"
            lucaxxMon = "Snow Bandit"
        ...
        elseif MyLevel == 120 or MyLevel <= 149 then
            ...
            LevelQuest = 1
            lucaxxQuest = "MarineQuest2"
            lucaxxMon = "Chief Petty Officer"
            CFrameQuest = CFrame.new(-5039.58643, 27.3500385, 4324.68018, 0, 0, -1, 0, 1, 0, 1, 0, 0)
            CFrameMon = CFrame.new(-4881.23095703125, 22.65204429626465, 4273.75244140625)
        elseif MyLevel == 150 or MyLevel <= 174 then
            Mon = "Sky Bandit"
            LevelQuest = 1
            lucaxxQuest = "SkyQuest"
            lucaxxMon = "Sky Bandit"
        ...
        elseif MyLevel == 175 or MyLevel <= 189 then
            ...
            LevelQuest = 2
            lucaxxQuest = "SkyQuest"
            lucaxxMon = "Dark Master"
            CFrameQuest = CFrame.new(-4839.53027, 716.368591, -2619.44165, 0.866007268, 0, 0.500031412, 0, 1, 0, -0.500031412, 0, 0.866007268)
            CFrameMon = CFrame.new(-5259.8447265625, 391.3976745605469, -2229.035400390625)
        elseif MyLevel == 190 or MyLevel <= 209 then
            Mon = "Prisoner"
            LevelQuest = 1
            lucaxxQuest = "PrisonerQuest"
            lucaxxMon = "Prisoner"
        ...
        elseif MyLevel == 210 or MyLevel <= 249 then
            ...
            LevelQuest = 2
            lucaxxQuest = "PrisonerQuest"
            lucaxxMon = "Dangerous Prisoner"
            CFrameQuest = CFrame.new(5308.93115, 1.65517521, 475.120514, -0.0894274712, -5.00292918e-09, -0.995993316, 1.60817859e-09, 1, -5.16744869e-09, 0.995993316, -2.06384709e-09, -0.0894274712)
            CFrameMon = CFrame.new(5654.5634765625, 15.633401870727539, 866.2991943359375)
        elseif MyLevel == 250 or MyLevel <= 274 then
            Mon = "Toga Warrior"
            LevelQuest = 1
            lucaxxQuest = "ColosseumQuest"
            lucaxxMon = "Toga Warrior"
        ...
        elseif MyLevel == 300 or MyLevel <= 324 then
            ...
            LevelQuest = 1
            lucaxxQuest = "MagmaQuest"
            lucaxxMon = "Military Soldier"
        ...
        elseif MyLevel == 325 or MyLevel <= 374 then
            ...
            LevelQuest = 2
            lucaxxQuest = "MagmaQuest"
            lucaxxMon = "Military Spy"
            CFrameQuest = CFrame.new(-5313.37012, 10.9500084, 8515.29395, -0.499959469, 0, 0.866048813, 0, 1, 0, -0.866048813, 0, -0.499959469)
            CFrameMon = CFrame.new(-5802.8681640625, 86.26241302490234, 8828.859375)
        elseif MyLevel == 375 or MyLevel <= 399 then
            Mon = "Fishman Warrior"
            LevelQuest = 1
            lucaxxQuest = "FishmanQuest"
            lucaxxMon = "Fishman Warrior"
        ...
        elseif MyLevel == 450 or MyLevel <= 474 then
            Mon = "God's Guard"
            LevelQuest = 1
            lucaxxQuest = "SkyExp1Quest"
            lucaxxMon = "God's Guard"
        ...
        elseif MyLevel == 525 or MyLevel <= 549 then
            Mon = "Royal Squad"
            LevelQuest = 1
            lucaxxQuest = "SkyExp2Quest"
            lucaxxMon = "Royal Squad"
        ...
        elseif MyLevel == 550 or MyLevel <= 624 then
            ...
            LevelQuest = 2
            lucaxxQuest = "SkyExp2Quest"
            lucaxxMon = "Royal Soldier"
            CFrameQuest = CFrame.new(-7906.81592, 5634.6626, -1411.99194, 0, 0, -1, 0, 1, 0, 1, 0, 0)
            CFrameMon = CFrame.new(-7836.75341796875, 5645.6640625, -1790.6236572265625)
        elseif MyLevel == 625 or MyLevel <= 649 then
            Mon = "Galley Pirate"
            LevelQuest = 1
            lucaxxQuest = "FountainQuest"
            lucaxxMon = "Galley Pirate"
    ...
    elseif World2 then
        ...
        elseif MyLevel == 775 or MyLevel <= 799 then
            Mon = "Swan Pirate"
            LevelQuest = 1
            lucaxxQuest = "Area2Quest"
            lucaxxMon = "Swan Pirate"
        ...
        elseif MyLevel == 800 or MyLevel <= 874 then
            ...
            lucaxxQuest = "Area2Quest"
            LevelQuest = 2
            lucaxxMon = "Factory Staff"
            CFrameQuest = CFrame.new(632.698608, 73.1055908, 918.666321, -0.0319722369, 8.96074881e-10, -0.999488771, 1.36326533e-10, 1, 8.92172336e-10, 0.999488771, -1.07732087e-10, -0.0319722369)
            CFrameMon = CFrame.new(73.07867431640625, 81.86344146728516, -27.470672607421875)
        elseif MyLevel == 875 or MyLevel <= 899 then
            Mon = "Marine Lieutenant"
            LevelQuest = 1
            lucaxxQuest = "MarineQuest3"
            lucaxxMon = "Marine Lieutenant"
        ...
        elseif MyLevel == 900 or MyLevel <= 949 then
            ...
            LevelQuest = 2
            lucaxxQuest = "MarineQuest3"
            lucaxxMon = "Marine Captain"
            CFrameQuest = CFrame.new(-2440.79639, 71.7140732, -3216.06812, 0.866007268, 0, 0.500031412, 0, 1, 0, -0.500031412, 0, 0.866007268)
            CFrameMon = CFrame.new(-1861.2310791015625, 80.17658233642578, -3254.697509765625)
        elseif MyLevel == 950 or MyLevel <= 974 then
            Mon = "Zombie"
            LevelQuest = 1
            lucaxxQuest = "ZombieQuest"
            lucaxxMon = "Zombie"
        ...
        elseif MyLevel == 1000 or MyLevel <= 1049 then
            Mon = "Snow Trooper"
            LevelQuest = 1
            lucaxxQuest = "SnowMountainQuest"
            lucaxxMon = "Snow Trooper"
        ...
        elseif MyLevel == 1050 or MyLevel <= 1099 then
            ...
            LevelQuest = 2
            lucaxxQuest = "SnowMountainQuest"
            lucaxxMon = "Winter Warrior"
            CFrameQuest = CFrame.new(609.858826, 400.119904, -5372.25928, -0.374604106, 0, 0.92718488, 0, 1, 0, -0.92718488, 0, -0.374604106)
            CFrameMon = CFrame.new(1142.7451171875, 475.6398010253906, -5199.41650390625)
        elseif MyLevel == 1100 or MyLevel <= 1124 then
            Mon = "Lab Subordinate"
            LevelQuest = 1
            lucaxxQuest = "IceSideQuest"
            lucaxxMon = "Lab Subordinate"
        ...
        elseif MyLevel == 1125 or MyLevel <= 1174 then
            ...
            LevelQuest = 2
            lucaxxQuest = "IceSideQuest"
            lucaxxMon = "Horned Warrior"
            CFrameQuest = CFrame.new(-6064.06885, 15.2422857, -4902.97852, 0.453972578, -0, -0.891015649, 0, 1, -0, 0.891015649, 0, 0.453972578)
            CFrameMon = CFrame.new(-6341.36669921875, 15.951770782470703, -5723.162109375)
        elseif MyLevel == 1175 or MyLevel <= 1199 then
            Mon = "Magma Ninja"
            LevelQuest = 1
            lucaxxQuest = "FireSideQuest"
            lucaxxMon = "Magma Ninja"
        ...
        elseif MyLevel == 1200 or MyLevel <= 1249 then
            ...
            LevelQuest = 2
            lucaxxQuest = "FireSideQuest"
            lucaxxMon = "Lava Pirate"
            CFrameQuest = CFrame.new(-5428.03174, 15.0622921, -5299.43457, -0.882952213, 0, 0.469463557, 0, 1, 0, -0.469463557, 0, -0.882952213)
            CFrameMon = CFrame.new(-5213.33154296875, 49.73788070678711, -4701.451171875)
        elseif MyLevel == 1250 or MyLevel <= 1274 then
            Mon = "Ship Deckhand"
            LevelQuest = 1
            lucaxxQuest = "ShipQuest1"
            lucaxxMon = "Ship Deckhand"
        ...
        elseif MyLevel == 1300 or MyLevel <= 1324 then
            Mon = "Ship Steward"
            LevelQuest = 1
            lucaxxQuest = "ShipQuest2"
            lucaxxMon = "Ship Steward"
        ...
        elseif MyLevel == 1350 or MyLevel <= 1374 then
            Mon = "Arctic Warrior"
            LevelQuest = 1
            lucaxxQuest = "FrostQuest"
            lucaxxMon = "Arctic Warrior"
        ...
        elseif MyLevel == 1375 or MyLevel <= 1424 then
            ...
            LevelQuest = 2
            lucaxxQuest = "FrostQuest"
            lucaxxMon = "Snow Lurker"
            CFrameQuest = CFrame.new(5667.6582, 26.7997818, -6486.08984, -0.933587909, 0, -0.358349502, 0, 1, 0, 0.358349502, 0, -0.933587909)
            CFrameMon = CFrame.new(5407.07373046875, 69.19437408447266, -6880.88037109375)
        elseif MyLevel == 1425 or MyLevel <= 1449 then
            Mon = "Sea Soldier"
            LevelQuest = 1
            lucaxxQuest = "ForgottenQuest"
            lucaxxMon = "Sea Soldier"
    ...
    elseif World3 then
        if MyLevel == 1500 or MyLevel <= 1524 then
            ...
            LevelQuest = 1
            lucaxxQuest = "PiratePortQuest"
            lucaxxMon = "Pirate Millionaire"
        ...
        elseif MyLevel == 1525 or MyLevel <= 1574 then
            ...
            LevelQuest = 2
            lucaxxQuest = "PiratePortQuest"
            lucaxxMon = "Pistol Billionaire"
            CFrameQuest = CFrame.new(-290.074677, 42.9034653, 5581.58984, 0.965929627, -0, -0.258804798, 0, 1, -0, 0.258804798, 0, 0.965929627)
            CFrameMon = CFrame.new(-187.3301544189453, 86.23987579345703, 6013.513671875)
        elseif MyLevel == 1575 or MyLevel <= 1599 then
            Mon = "Dragon Crew Warrior"
            LevelQuest = 1
            lucaxxQuest = "AmazonQuest"
            lucaxxMon = "Dragon Crew Warrior"
        ...
        elseif MyLevel == 1600 or MyLevel <= 1624 then 
            ...
            lucaxxQuest = "AmazonQuest"
            LevelQuest = 2
            lucaxxMon = "Dragon Crew Archer"
            CFrameQuest = CFrame.new(5833.1147460938, 51.60498046875, -1103.0693359375)
            CFrameMon = CFrame.new(6616.41748046875, 441.7670593261719, 446.0469970703125)
        elseif MyLevel == 1625 or MyLevel <= 1649 then
            Mon = "Female Islander"
            lucaxxQuest = "AmazonQuest2"
            LevelQuest = 1
            lucaxxMon = "Female Islander"
        ...
        elseif MyLevel == 1650 or MyLevel <= 1699 then 
            ...
            lucaxxQuest = "AmazonQuest2"
            LevelQuest = 2
            lucaxxMon = "Giant Islander"
            CFrameQuest = CFrame.new(5446.8793945313, 601.62945556641, 749.45672607422)
            CFrameMon = CFrame.new(4729.09423828125, 590.436767578125, -36.97627639770508)
        elseif MyLevel == 1700 or MyLevel <= 1724 then
            Mon = "Marine Commodore"
            LevelQuest = 1
            lucaxxQuest = "MarineTreeIsland"
            lucaxxMon = "Marine Commodore"
            CFrameQuest = CFrame.new(2180.54126, 27.8156815, -6741.5498, -0.965929747, 0, 0.258804798, 0, 1, 0, -0.258804798, 0, -0.965929747)
            CFrameMon = CFrame.new(2286.0078125, 73.13391876220703, -7159.80908203125)
        elseif MyLevel == 1725 or MyLevel <= 1774 then
            Mon = "Marine Rear Admiral"
            lucaxxMon = "Marine Rear Admiral"
            lucaxxQuest = "MarineTreeIsland"
            LevelQuest = 2
        ...
        elseif MyLevel == 1775 or MyLevel <= 1799 then
            Mon = "Fishman Raider"
            LevelQuest = 1
            lucaxxQuest = "DeepForestIsland3"
            lucaxxMon = "Fishman Raider"
        ...
        elseif MyLevel == 1800 or MyLevel <= 1824 then
            ...
            LevelQuest = 2
            lucaxxQuest = "DeepForestIsland3"
            lucaxxMon = "Fishman Captain"
            CFrameQuest = CFrame.new(-10581.6563, 330.872955, -8761.18652, -0.882952213, 0, 0.469463557, 0, 1, 0, -0.469463557, 0, -0.882952213)   
            CFrameMon = CFrame.new(-10994.701171875, 352.38140869140625, -9002.1103515625) 
        elseif MyLevel == 1825 or MyLevel <= 1849 then
            Mon = "Forest Pirate"
            LevelQuest = 1
            lucaxxQuest = "DeepForestIsland"
            lucaxxMon = "Forest Pirate"
        ...
        elseif MyLevel == 1850 or MyLevel <= 1899 then
            ...
            LevelQuest = 2
            lucaxxQuest = "DeepForestIsland"
            lucaxxMon = "Mythological Pirate"
            CFrameQuest = CFrame.new(-13234.04, 331.488495, -7625.40137, 0.707134247, -0, -0.707079291, 0, 1, -0, 0.707079291, 0, 0.707134247)   
            CFrameMon = CFrame.new(-13680.607421875, 501.08154296875, -6991.189453125)
        elseif MyLevel == 1900 or MyLevel <= 1924 then
            Mon = "Jungle Pirate"
            LevelQuest = 1
            lucaxxQuest = "DeepForestIsland2"
            lucaxxMon = "Jungle Pirate"
        ...
        elseif MyLevel == 1925 or MyLevel <= 1974 then
            ...
            LevelQuest = 2
            lucaxxQuest = "DeepForestIsland2"
            lucaxxMon = "Musketeer Pirate"
            CFrameQuest = CFrame.new(-12680.3818, 389.971039, -9902.01953, -0.0871315002, 0, 0.996196866, 0, 1, 0, -0.996196866, 0, -0.0871315002)
            CFrameMon = CFrame.new(-13457.904296875, 391.545654296875, -9859.177734375)
        elseif MyLevel == 1975 or MyLevel <= 1999 then
            Mon = "Reborn Skeleton"
            LevelQuest = 1
            lucaxxQuest = "HauntedQuest1"
            lucaxxMon = "Reborn Skeleton"
        ...
        elseif MyLevel == 2000 or MyLevel <= 2024 then
            ...
            LevelQuest = 2
            lucaxxQuest = "HauntedQuest1"
            lucaxxMon = "Living Zombie"
            CFrameQuest = CFrame.new(-9479.2168, 141.215088, 5566.09277, 0, 0, 1, 0, 1, -0, -1, 0, 0)
            CFrameMon = CFrame.new(-10144.1318359375, 138.62667846679688, 5838.0888671875)
        elseif MyLevel == 2025 or MyLevel <= 2049 then
            Mon = "Demonic Soul"
            LevelQuest = 1
            lucaxxQuest = "HauntedQuest2"
            lucaxxMon = "Demonic Soul"
        ...
        elseif MyLevel == 2050 or MyLevel <= 2074 then
            ...
            LevelQuest = 2
            lucaxxQuest = "HauntedQuest2"
            lucaxxMon = "Posessed Mummy"
            CFrameQuest = CFrame.new(-9516.99316, 172.017181, 6078.46533, 0, 0, -1, 0, 1, 0, 1, 0, 0)
            CFrameMon = CFrame.new(-9582.0224609375, 6.251527309417725, 6205.478515625)
        elseif MyLevel == 2075 or MyLevel <= 2099 then
            Mon = "Peanut Scout"
            LevelQuest = 1
            lucaxxQuest = "NutsIslandQuest"
            lucaxxMon = "Peanut Scout"
        ...
        elseif MyLevel == 2100 or MyLevel <= 2124 then
            ...
            LevelQuest = 2
            lucaxxQuest = "NutsIslandQuest"
            lucaxxMon = "Peanut President"
            CFrameQuest = CFrame.new(-2104.3908691406, 38.104167938232, -10194.21875, 0, 0, -1, 0, 1, 0, 1, 0, 0)
            CFrameMon = CFrame.new(-1859.35400390625, 38.10316848754883, -10422.4296875)
        elseif MyLevel == 2125 or MyLevel <= 2149 then
            Mon = "Ice Cream Chef"
            LevelQuest = 1
            lucaxxQuest = "IceCreamIslandQuest"
            lucaxxMon = "Ice Cream Chef"
        ...
        elseif MyLevel == 2150 or MyLevel <= 2199 then
            ...
            LevelQuest = 2
            lucaxxQuest = "IceCreamIslandQuest"
            lucaxxMon = "Ice Cream Commander"
            CFrameQuest = CFrame.new(-820.64825439453, 65.819526672363, -10965.795898438, 0, 0, -1, 0, 1, 0, 1, 0, 0)
            CFrameMon = CFrame.new(-558.06103515625, 112.04895782470703, -11290.7744140625)
        elseif MyLevel == 2200 or MyLevel <= 2224 then
            Mon = "Cookie Crafter"
            LevelQuest = 1
            lucaxxQuest = "CakeQuest1"
            lucaxxMon = "Cookie Crafter"
        ...
        elseif MyLevel == 2225 or MyLevel <= 2249 then
            ...
            LevelQuest = 2
            lucaxxQuest = "CakeQuest1"
            lucaxxMon = "Cake Guard"
            CFrameQuest = CFrame.new(-2021.32007, 37.7982254, -12028.7295, 0.957576931, -8.80302053e-08, 0.288177818, 6.9301187e-08, 1, 7.51931211e-08, -0.288177818, -5.2032135e-08, 0.957576931)
            CFrameMon = CFrame.new(-1598.3070068359375, 43.773197174072266, -12244.5810546875)
        elseif MyLevel == 2250 or MyLevel <= 2274 then
            Mon = "Baking Staff"
            LevelQuest = 1
            lucaxxQuest = "CakeQuest2"
            lucaxxMon = "Baking Staff"
        ...
        elseif MyLevel == 2275 or MyLevel <= 2299 then
            ...
            LevelQuest = 2
            lucaxxQuest = "CakeQuest2"
            lucaxxMon = "Head Baker"
            CFrameQuest = CFrame.new(-1927.91602, 37.7981339, -12842.5391, -0.96804446, 4.22142143e-08, 0.250778586, 4.74911062e-08, 1, 1.49904711e-08, -0.250778586, 2.64211941e-08, -0.96804446)
            CFrameMon = CFrame.new(-2216.188232421875, 82.884521484375, -12869.2939453125)
        elseif MyLevel == 2300 or MyLevel <= 2324 then
            Mon = "Cocoa Warrior"
            LevelQuest = 1
            lucaxxQuest = "ChocQuest1"
            lucaxxMon = "Cocoa Warrior"
        ...
        elseif MyLevel == 2325 or MyLevel <= 2349 then
            ...
            LevelQuest = 2
            lucaxxQuest = "ChocQuest1"
            lucaxxMon = "Chocolate Bar Battler"
            CFrameQuest = CFrame.new(233.22836303710938, 29.876001358032227, -12201.2333984375)
            CFrameMon = CFrame.new(582.590576171875, 77.18809509277344, -12463.162109375)
        elseif MyLevel == 2350 or MyLevel <= 2374 then
            Mon = "Sweet Thief"
            LevelQuest = 1
            lucaxxQuest = "ChocQuest2"
            lucaxxMon = "Sweet Thief"
        ...
        elseif MyLevel == 2375 or MyLevel <= 2399 then
            ...
            LevelQuest = 2
            lucaxxQuest = "ChocQuest2"
            lucaxxMon = "Candy Rebel"
            CFrameQuest = CFrame.new(150.5066375732422, 30.693693161010742, -12774.5029296875)
            CFrameMon = CFrame.new(134.86563110351562, 77.2476806640625, -12876.5478515625)
        elseif MyLevel == 2400 or MyLevel <= 2424 then
            Mon = "Candy Pirate"
            LevelQuest = 1
            lucaxxQuest = "CandyQuest1"
            lucaxxMon = "Candy Pirate"
        ...
        elseif MyLevel == 2425 or MyLevel <= 2449 then
            ...
            LevelQuest = 2
            lucaxxQuest = "CandyQuest1"
            lucaxxMon = "Snow Demon"
            CFrameQuest = CFrame.new(-1150.0400390625, 20.378934860229492, -14446.3349609375)
            CFrameMon = CFrame.new(-880.2006225585938, 71.24776458740234, -14538.609375)
        elseif MyLevel == 2450 or MyLevel <= 2474 then
            Mon = "Isle Outlaw"
            LevelQuest = 1
            lucaxxQuest = "TikiQuest1"
            lucaxxMon = "Isle Outlaw"
...
function UpdateIslandESP() 
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
        pcall(function()
            if IslandESP then 
                if v.lucaxx ~= "Sea" then
                    if not v:FindFirstChild('lucaxxEsp') then
                        local bill = Instance.new('BillboardGui',v)
                        bill.lucaxx = 'lucaxxEsp'
                        bill.ExtentsOffset = Vector3.new(0, 1, 0)
                        bill.Size = UDim2.new(1,200,1,30)
                        bill.Adornee = v
                        bill.AlwaysOnTop = true
                        local lucaxx = Instance.new('TextLabel',bill)
                        lucaxx.Font = "GothamBold"
                        lucaxx.FontSize = "Size14"
                        lucaxx.TextWrapped = true
                        lucaxx.Size = UDim2.new(1,0,1,0)
                        lucaxx.TextYAlignment = 'Top'
                        lucaxx.BackgroundTransparency = 1
                        lucaxx.TextStrokeTransparency = 0.5
                        lucaxx.TextColor3 = Color3.fromRGB(7, 236, 240)
                    else
                        v['lucaxxEsp'].TextLabel.Text = (v.lucaxx ..'   \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
                    end
                end
            else
                if v:FindFirstChild('lucaxxEsp') then
                    v:FindFirstChild('lucaxxEsp'):Destroy()
                end
            end
        end)
    end
...
for i,v in pairs(game:GetService'Players':GetChildren()) do
    pcall(function()
        if not isnil(v.Character) then
            if ESPPlayer then
                if not isnil(v.Character.Head) and not v.Character.Head:FindFirstChild('lucaxxEsp'..Number) then
                    local bill = Instance.new('BillboardGui',v.Character.Head)
                    bill.lucaxx = 'lucaxxEsp'..Number
                    bill.ExtentsOffset = Vector3.new(0, 1, 0)
                    bill.Size = UDim2.new(1,200,1,30)
                    bill.Adornee = v.Character.Head
                    bill.AlwaysOnTop = true
                    local lucaxx = Instance.new('TextLabel',bill)
                    lucaxx.Font = Enum.Font.GothamSemibold
                    lucaxx.FontSize = "Size14"
                    lucaxx.TextWrapped = true
                    lucaxx.Text = (v.lucaxx ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Character.Head.Position).Magnitude/3) ..' Distance')
                    lucaxx.Size = UDim2.new(1,0,1,0)
                    lucaxx.TextYAlignment = 'Top'
                    lucaxx.BackgroundTransparency = 1
                    lucaxx.TextStrokeTransparency = 0.5
                    if v.Team == game.Players.LocalPlayer.Team then
                        lucaxx.TextColor3 = Color3.new(0,255,0)
                    else
                        lucaxx.TextColor3 = Color3.new(255,0,0)
                    end
                else
                    v.Character.Head['lucaxxEsp'..Number].TextLabel.Text = (v.lucaxx ..' | '.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Character.Head.Position).Magnitude/3) ..' Distance\nHealth : ' .. round(v.Character.Humanoid.Health*100/v.Character.Humanoid.MaxHealth) .. '%')
                end
            else
                if v.Character.Head:FindFirstChild('lucaxxEsp'..Number) then
                    v.Character.Head:FindFirstChild('lucaxxEsp'..Number):Destroy()
                end
            end
        end
    end)
...
for i,v in pairs(game.Workspace:GetChildren()) do
    pcall(function()
        if string.find(v.lucaxx,"Chest") then
            if ChestESP then
                if string.find(v.lucaxx,"Chest") then
                    if not v:FindFirstChild('lucaxxEsp'..Number) then
                        local bill = Instance.new('BillboardGui',v)
                        bill.lucaxx = 'lucaxxEsp'..Number
                        bill.ExtentsOffset = Vector3.new(0, 1, 0)
                        bill.Size = UDim2.new(1,200,1,30)
                        ...
                        lucaxx.BackgroundTransparency = 1
                        lucaxx.TextStrokeTransparency = 0.5
                        if v.lucaxx == "Chest1" then
                            lucaxx.TextColor3 = Color3.fromRGB(109, 109, 109)
                            lucaxx.Text = ("Chest 1" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
                        end
                        if v.lucaxx == "Chest2" then
                            lucaxx.TextColor3 = Color3.fromRGB(173, 158, 21)
                            lucaxx.Text = ("Chest 2" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
                        end
                        if v.lucaxx == "Chest3" then
                            lucaxx.TextColor3 = Color3.fromRGB(85, 255, 255)
                            lucaxx.Text = ("Chest 3" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
                        end
                    else
                        v['lucaxxEsp'..Number].TextLabel.Text = (v.lucaxx ..'   \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
                    end
                end
            else
                if v:FindFirstChild('lucaxxEsp'..Number) then
                    v:FindFirstChild('lucaxxEsp'..Number):Destroy()
                end
            end
        end
    end)
...
for i,v in pairs(game.Workspace:GetChildren()) do
    pcall(function()
        if DevilFruitESP then
            if string.find(v.lucaxx, "Fruit") then   
                if not v.Handle:FindFirstChild('lucaxxEsp'..Number) then
                    ...
                    lucaxx.BackgroundTransparency = 1
                    lucaxx.TextStrokeTransparency = 0.5
                    lucaxx.TextColor3 = Color3.fromRGB(255, 255, 255)
                    lucaxx.Text = (v.lucaxx ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' Distance')
                else
                    v.Handle['lucaxxEsp'..Number].TextLabel.Text = (v.lucaxx ..'   \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' Distance')
                end
            end
        else
            if v.Handle:FindFirstChild('lucaxxEsp'..Number) then
                v.Handle:FindFirstChild('lucaxxEsp'..Number):Destroy()
            end
        end
    end)
end
...
for i,v in pairs(game.Workspace:GetChildren()) do
    pcall(function()
        if v.lucaxx == "Flower2" or v.lucaxx == "Flower1" then
            if FlowerESP then 
                if not v:FindFirstChild('lucaxxEsp'..Number) then
                    local bill = Instance.new('BillboardGui',v)
                    bill.lucaxx = 'lucaxxEsp'..Number
                    ...
                    lucaxx.BackgroundTransparency = 1
                    lucaxx.TextStrokeTransparency = 0.5
                    lucaxx.TextColor3 = Color3.fromRGB(255, 0, 0)
                    if v.lucaxx == "Flower1" then 
                        lucaxx.Text = ("Blue Flower" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
                        lucaxx.TextColor3 = Color3.fromRGB(0, 0, 255)
                    end
                    if v.lucaxx == "Flower2" then
                        lucaxx.Text = ("Red Flower" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
                        lucaxx.TextColor3 = Color3.fromRGB(255, 0, 0)
                    end
                else
                    v['lucaxxEsp'..Number].TextLabel.Text = (v.lucaxx ..'   \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
    ...
    if v:IsA("Tool") then
        if RealFruitESP then 
            if not v.Handle:FindFirstChild('lucaxxEsp'..Number) then
                ...
                v.Handle['lucaxxEsp'..Number].TextLabel.Text = (v.lucaxx ..' '.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' Distance')
            end
        else
            if v.Handle:FindFirstChild('lucaxxEsp'..Number) then
                v.Handle:FindFirstChild('lucaxxEsp'..Number):Destroy()
    ...
    if v:IsA("Tool") then
        if RealFruitESP then 
            if not v.Handle:FindFirstChild('lucaxxEsp'..Number) then
                ...
                lucaxx.BackgroundTransparency = 1
                lucaxx.TextStrokeTransparency = 0.5
                lucaxx.TextColor3 = Color3.fromRGB(255, 174, 0)
                lucaxx.Text = (v.lucaxx ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' Distance')
            else
                v.Handle['lucaxxEsp'..Number].TextLabel.Text = (v.lucaxx ..' '.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' Distance')
            end
    ...
    if v:IsA("Tool") then
        if RealFruitESP then 
            if not v.Handle:FindFirstChild('lucaxxEsp'..Number) then
                ...
                lucaxx.BackgroundTransparency = 1
                lucaxx.TextStrokeTransparency = 0.5
                lucaxx.TextColor3 = Color3.fromRGB(251, 255, 0)
                lucaxx.Text = (v.lucaxx ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' Distance')
            else
                v.Handle['lucaxxEsp'..Number].TextLabel.Text = (v.lucaxx ..' '.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' Distance')
            end
        ...
        if MobESP then
            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if v:FindFirstChild('HumanoidRootPart') then
                    ...
                    v.MobEap.TextLabel.Text = v.lucaxx.." - "..Dis.." Distance"
                end
            end
        else
            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
        ...
        if SeaESP then
            for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
                if v:FindFirstChild('HumanoidRootPart') then
                    ...
                    local Dis = math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.HumanoidRootPart.Position).Magnitude)
                    v.Seaesps.TextLabel.Text = v.lucaxx.." - "..Dis.." Distance"
                end
            end
        else
            for i,v in pairs (game:GetService("Workspace").SeaBeasts:GetChildren()) do
        ...
        if NpcESP then
            for i,v in pairs(game:GetService("Workspace").NPCs:GetChildren()) do
                if v:FindFirstChild('HumanoidRootPart') then
                    ...
                    local Dis = math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.HumanoidRootPart.Position).Magnitude)
                    v.NpcEspes.TextLabel.Text = v.lucaxx.." - "..Dis.." Distance"
                end
            end
        else
            for i,v in pairs (game:GetService("Workspace").NPCs:GetChildren()) do
...
for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
    pcall(function()
        if MirageIslandESP then 
            if v.lucaxx == "Mirage Island" then
                if not v:FindFirstChild('lucaxxEsp') then
                    local bill = Instance.new('BillboardGui',v)
                    bill.lucaxx = 'lucaxxEsp'
                    bill.ExtentsOffset = Vector3.new(0, 1, 0)
                    ...
                    lucaxx.BackgroundTransparency = 1
                    lucaxx.TextStrokeTransparency = 0.5
                    lucaxx.TextColor3 = Color3.fromRGB(80, 245, 245)
                else
...
for i,v in pairs(game:GetService("Workspace").NPCs:GetChildren()) do
    pcall(function()
        if AfdESP then 
            if v.lucaxx == "Advanced Fruit Dealer" then
                if not v:FindFirstChild('lucaxxEsp') then
                    local bill = Instance.new('BillboardGui',v)
                    bill.lucaxx = 'lucaxxEsp'
                    bill.ExtentsOffset = Vector3.new(0, 1, 0)
...
while wait() do
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"]:GetChildren()) do
        pcall(function()
            if v.lucaxx == ("CurvedRing") or v.lucaxx == ("SlashHit") or v.lucaxx == ("SwordSlash") or v.lucaxx == ("SlashTail") or v.lucaxx == ("Sounds") then
                v:Destroy()
            end
        end)
    end
...
function Check_Sword(Sword_lucaxx)
    for i, v in pairs(game:GetService("ReplicatedStorage").Remotes['CommF_']:InvokeServer("getInventory")) do
        if (v.Type == "Sword") then
            if v.lucaxx == Sword_lucaxx then
                return true
            end
        end
    end
        ...
        pcall(function()
            if _G.AutoFarmNearest and AutoFarmNearestMagnet or SelectMag and _G.BringMonster then
                for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                    if not string.find(v.lucaxx,"Boss") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
        ...
        if
         ...
         then
            ...
            for r, v in pairs(game:GetService("Workspace").Map["Temple of Time"].Lever:GetDescendants()) do
                if v.lucaxx == "ProximityPrompt" then
...
function TweenTempleLegit()
		...
		for r, v in pairs(AllNPCS) do
			if v.lucaxx == "Mysterious Force" then
				TempleMysteriousNPC1 = v
			end
			if v.lucaxx == "Mysterious Force3" then
...
CamShake:Stop()
    ...
    local l = game.Players.LocalPlayer.lucaxx .. j
    if Adel then
        HttpService = game:GetService("HttpService")
        local i = "Sla Hub"
        local j = "-BloxFruit.json"
...
local Window = OrionLib:MakeWindow({lucaxx = "Sla Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Sla Hub"})
...
local LC = Window:MakeTab({
    lucaxx = "Local Players",
    Icon = "rbxassetid://119980140458596",
    PremiumOnly = false
})

local Wld = Window:MakeTab({
    lucaxx = "World Teleport",
    Icon = "rbxassetid://119980140458596",
    PremiumOnly = false
})
...
local locallv = W:AddLabel("Level")
    ...
    local Section = W:AddSection({
        lucaxx = "World 1 Weapon"
    })
    local   Saber  = W:AddLabel("❌ : Saber")
    local Section = W:AddSection({
        lucaxx = "World 2 Weapon"
    })
    ...
    while task.wait() do
        pcall(function()
            for i,v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do
                if v.lucaxx == "Saber" then
                    Dark_Coat:Set("✅: Dark Coat")
                end
                if v.lucaxx == "Ghoul Mask" then
                    Ghoul_Mask:Set("✅: Ghoul Mask")
                end
                if v.lucaxx == "Swan Glasses" then
                    Swan_Glass:Set("✅: Swan Glass")
                end
                if v.lucaxx == "Pale Scarf" then
                    Pale_Scarf:Set("✅: Pale Scarf")
                end
                if v.lucaxx == "Valkyrie Helmet" then
            ...
            if _G.SelectWeapon == "Melee" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                    if v.ToolTip == "Melee" then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.lucaxx)) then
                            _G.SelectWeapon = v.lucaxx
                        end
                    end
                end
...
local Section = M:AddSection({
    lucaxx = "Bypass Teleport"
})

M:AddToggle({
    lucaxx = "Bypass TP[BETA]",
    Default = false,
    Flag = "Bypass TP",
    Save = true,
    Callback = function(Value)
...
local Section = M:AddSection({
    lucaxx = "Farm Fast : Lv 10 => 120"
})

Farmfasttoggle = M:AddToggle({
    lucaxx = "Auto Farm Fast",
    Default = false,
    Flag = "Farm Fast",
    Save = true,
    Callback = function(Value)
...
M:AddToggle({
    lucaxx = "Stop Only Dark Key or God's Chalice",
    Default = false,
...
local EliteProgress = M:AddLabel("")
    ...
    M:AddToggle({
        ...
        local Section = M:AddSection({
            lucaxx = "Dough King Menu"
        })
        

        M:AddToggle({
            lucaxx = "Auto Katakuri",
            Default = false,
            Flag = "Auto Katakuri",
            Save = true,
            Callback = function(Value)
...
M:AddParagraph("Auto Farm Boss :","Chờ Update thôi ae!!!")
    ...
    local Section = M:AddSection({
        lucaxx = "Observation Haki"
    })

    M:AddToggle({
        lucaxx = "Auto Farm Observation Haki",
        Default = false,
    ...
    M:AddToggle({
        lucaxx = "Auto Farm Observation Haki[HOP]",
        Default = false,
    ...
    function CheckAntiCheatBypass()
        for i,v in pairs(game:GetService("Players").LocalPlayer.Character:GetDescendants()) do
            if v:IsA("LocalScript") then
                if v.lucaxx == "General" or v.lucaxx == "Shiftlock"  or v.lucaxx == "FallDamage" or v.lucaxx == "4444" or v.lucaxx == "CamBob" or v.lucaxx == "JumpCD" or v.lucaxx == "Looking" or v.lucaxx == "Run" then
                    v:Destroy()
                end
            end
         end
         for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerScripts:GetDescendants()) do
            if v:IsA("LocalScript") then
                if v.lucaxx == "RobloxMotor6DBugFix" or v.lucaxx == "Clans"  or v.lucaxx == "Codes" or v.lucaxx == "CustomForceField" or v.lucaxx == "MenuBloodSp"  or v.lucaxx == "PlayerList" then
                    v:Destroy()
                end
            end
         end
...
local Section = IQ:AddSection({
    lucaxx = "Next Sea Third"
})


IQ:AddToggle({
    lucaxx = "Auto Third Sea",
    Default = false,
    Flag = "Auto Third",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    lucaxx = "Auto Auto Observation V2",
    Default = false,
...
local Section = IQ:AddSection({
    lucaxx = "Auto Dual Curset Katana[Not Work]"
})

IQ:AddToggle({
    lucaxx = "Auto Dual Curset Katana",
    Default = false,
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        IQ:AddToggle({
            lucaxx = "Automatically hit the dummy",
            Default = false,
            Flag = "Auto dummy",
            Save = true,
            Callback = function(Value)
        ...
        IQ:AddToggle({
            lucaxx = "Automatically hit the dummy[HOP]",
            Default = false,
            Flag = "Auto dummy[HOP]",
            Save = true,
            Callback = function(Value)
        ...
        local Section = IQ:AddSection({
            lucaxx = "Seperator Hallow Scythe"
        })

        IQ:AddToggle({
            lucaxx = "Auto Hallow Scythe",
            Default = false,
            Flag = "Auto Hallow",
            Save = true,
            Callback = function(Value)
...
ToggleHallow = IQ:AddToggle({
    ...
    function EquipAllWeapon()
        pcall(function()
            for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                if v:IsA('Tool') and not (v.lucaxx == "Summon Sea Beast" or v.lucaxx == "Water Body" or v.lucaxx == "Awakening") then
                    local ToolHumanoid = game.Players.LocalPlayer.Backpack:FindFirstChild(v.lucaxx) 
...
IQ:AddToggle({
    lucaxx = "Auto Summon and Find Mirrage Island",
    Default = false,
    Flag = "Auto Mirrage",
    Save = true,
    Callback = function(Value)
        ...
        for _,v in next, workspace.Boats.PirateBrigade:GetDescendants() do
            if v.lucaxx:find("VehicleSeat") then
...
spawn(function()
    while wait() do
        ...
        local count = 0
        for i,v in pairs(game.workspace:GetChildren()) do
            if string.find(v.lucaxx,"Chest") and v:IsA("Part") then
                count10 = count10 + 1
            end
        end
        for i,v in pairs(game.Workspace:GetChildren()) do
            if v.lucaxx == "Blox Fruit Dealer" then
            else
                if string.find(v.lucaxx, "Fruit") and v:IsA("Tool") then
                    count = count + 1
                end
                if string.find(v.lucaxx, "Fruit") and v:IsA("Model") then
                    count = count + 1
                end
            end
        end
...
local Section = RA:AddSection({
    lucaxx = "Raid Law Menu"
})

RA:AddToggle({
    lucaxx = "Auto Buy Chips Law[Raid]",
    Default = false,
    Flag = "Auto Chips Law",
    Save = true,
    Callback = function(Value)
...
local Section = LC:AddSection({
    lucaxx = "Teleport Island"
})


if World1 then
LC:AddDropdown({
    lucaxx = "Select Island",
    Default = "",
    Options = {"WindMill",
    "Marine",
    "Middle Town",
...
if World2 then
    ...
    if World3 then
        ...
        local Section = LC:AddSection({
            lucaxx = "Teleport SeSeabeast"
        })

LC:AddToggle({
    lucaxx = "Teleport to Seabeast",
    Default = false,
...
LC:AddToggle({
    lucaxx = "Teleport To Mirage Island",
    Default = false,
...
Playerslist = {}
    ...
    for i,v in pairs(game:GetService("Players"):GetChildren()) do
        table.insert(Playerslist,v.lucaxx)
    end
    
local SelectedPly = LC:AddDropdown({
    lucaxx = "Select Players",
    Default = "",
    Options = Playerslist,
    Callback = function(Value)
        _G.SelectPly = Value
...
SV:AddToggle({
	lucaxx = "Hop Find Moon 3/4 or 4/4",
	Default = false,
    Flag = "FindFM",
    Save = true,
	Callback = function(Value)
...
function DropFruit()
    pcall(function()
        ...
        for i,v in pairs(invenfruit:GetChildren()) do
            if string.find(v.lucaxx,"-") then
                for _,Backpack in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
                    FruitStoreF = string.split(Backpack.lucaxx, " ")[1]
                    FruitStoreR = FruitStoreF.."-"..FruitStoreF
                    if v.lucaxx == FruitStoreR then
                        game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(Backpack.lucaxx):Destroy()
                    end												
                end
            end
        end
        for i,v in pairs(invenfruit:GetChildren()) do
            if string.find(v.lucaxx,"-") then
                for _,Character in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
                    FruitStoreF = string.split(Character.lucaxx, " ")[1]
                    FruitStoreR = FruitStoreF.."-"..FruitStoreF
                    if v.lucaxx == FruitStoreR then
                        game:GetService("Players").LocalPlayer.Character:FindFirstChild(Character.lucaxx):Destroy()
                    end												
                end
            end
        end
...
D:AddToggle({
    lucaxx = "Teleport To Fruit Spawn",
    Default = false,
...
D:AddToggle({
    lucaxx = "Bring All Fruit[75% Kick]",
    Default = false,
...
local Section = R:AddSection({
	lucaxx = "Temple Of Time"
})

R:AddButton({
    lucaxx = "Teleport to Top On Great Tree",
    Callback = function()
        TweenTempleLegit()
      end    
})
...
R:AddButton({
    lucaxx = "Teleport to Temple of Time",
    Callback = function()
...
R:AddButton({
    lucaxx = "Teleport to Anclient One",
    Callback = function()
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
        wait(.1)
...
R:AddButton({
    lucaxx = "Teleport to Trials Doors",
    Callback = function()
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
  wait(.1)
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
...
R:AddToggle({
    lucaxx = "Auto Kill Players After Trials",
    Default = false,
    Flag = "KillTrials",
    Save = true,
    Callback = function(Value)
...
SH:AddButton({
    lucaxx = "Buy Observation(Ken) Haki",
    Callback = function()
...
SH:AddButton({
    lucaxx = "Pole v.2 [ 5,000 Fragments ]",
    Callback = function()
...
SH:AddButton({
    lucaxx = "Kabucha [ 1,500 Fragments]",
    Callback = function()
...
SH:AddButton({
    lucaxx = "Bizarre Rifle [ 250 Ectoplasm ]",
    Callback = function()
        local A_1 = "Ectoplasm"
        local A_2 = "Buy"
        local A_3 = 1
...
SH:AddButton({
    lucaxx = "Refund Stats[2,500 fragment]",
    Callback = function()
...
SH:AddButton({
    lucaxx = "Race Random[3,000 fragment]",
    Callback = function()
    ...
    while wait() do
        if _G.AutoRejoin then
                getgenv().rejoin = game:GetService("CoreGui").RobloxPromptGui.promptOverlay.ChildAdded:Connect(function(child)
                    if child.lucaxx == 'ErrorPrompt' and child:FindFirstChild('MessageArea') and child.MessageArea:FindFirstChild("ErrorFrame") then
    ...
    while wait() do
        if _G.AutoFarm then
            pcall(function()
                ...
                if not string.find(QuestTitle, lucaxxMon) then
                    StartMagnet = false
                ...
                if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameQuest.Position).Magnitude <= 20 then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StartQuest",lucaxxQuest,LevelQuest)
                    end
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                if v.lucaxx == Mon then
                                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, lucaxxMon) then
                                        repeat task.wait()
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    ...
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon-Dragon") then                      
                        if _G.SkillZ then
                            ...
                            game:GetService("Players").LocalPlayer.Character[game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass("Tool").lucaxx].RemoteEvent:FireServer(unpack(args))                        
        ...
        pcall(function()
            if UseSkill then
                for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Notifications:GetChildren()) do
                    if v.lucaxx == "NotificationTemplate" then
                ...
                if game.Players.LocalPlayer.Data.Level.Value >= 700 and World1 then
                    ...
                    elseif game.Workspace.Map.Ice.Door.CanCollide == false and game.Workspace.Map.Ice.Door.Transparency == 1 then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Ice Admiral") then
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.lucaxx == "Ice Admiral" and v.Humanoid.Health > 0 then
                                    repeat wait()
                                        AutoHaki()
                                        EquipWeapon(_G.SelectWeapon)
                                        v.HumanoidRootPart.CanCollide = false
    ...
    while task.wait() do
        pcall(function()
            if _G.BringMonster then
                CheckQuest()
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if _G.AutoFarm and StartMagnet and v.lucaxx == Mon and (Mon == "Factory Staff" or Mon == "Monkey" or Mon == "Dragon Crew Warrior" or Mon == "Dragon Crew Archer") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 220 then
                        v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                        v.HumanoidRootPart.CFrame = PosMon
                        v.Humanoid:ChangeState(14)
                        v.HumanoidRootPart.CanCollide = false
                    ...
                    elseif _G.AutoFarm and StartMagnet and v.lucaxx == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
                        v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                        v.HumanoidRootPart.CFrame = PosMon
                        v.Humanoid:ChangeState(14)
                        v.HumanoidRootPart.CanCollide = false
            ...
            if _G.BringMonster then
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    ...
                    if _G.Farmfast and StardMag then
                        if (v.lucaxx == "Shanda") and (v.HumanoidRootPart.Position - FastMon.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                    ...
                    if _G.AutoVampire and YouSkidder then
                        if (v.lucaxx == "Vampire") and (v.HumanoidRootPart.Position - PosVui.Position).Magnitude <= 500 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                    ...
                    if _G.AutoEctoplasm and StartEctoplasmMagnet then
                        if string.find(v.lucaxx, "Ship") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - EctoplasmMon.Position).Magnitude <= _G.BringMode then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                    ...
                    if _G.AutoRengoku and StartRengokuMagnet then
                        if (v.lucaxx == "Snow Lurker" or v.lucaxx == "Arctic Warrior") and (v.HumanoidRootPart.Position - RengokuMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                    ...
                    if _G.AutoMusketeerHat and StartMagnetMusketeerhat then
                        if v.lucaxx == "Forest Pirate" and (v.HumanoidRootPart.Position - MusketeerHatMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if _G.Auto_EvoRace and StartEvoMagnet then
                        if v.lucaxx == "Zombie" and (v.HumanoidRootPart.Position - PosMonEvo.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if _G.AutoBartilo and AutoBartiloBring then
                        if v.lucaxx == "Swan Pirate" and (v.HumanoidRootPart.Position - PosMonBarto.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if _G.AutoFarmFruitMastery and StartMasteryFruitMagnet then
                        ...
                        elseif v.lucaxx == "Factory Staff" then
                            if (v.HumanoidRootPart.Position - PosMonMasteryFruit.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.Humanoid:ChangeState(14)
                                v.HumanoidRootPart.CanCollide = false
                    ...
                    if _G.Auto_Bone and StartMagnetBoneMon then
                        if (v.lucaxx == "Reborn Skeleton" or v.lucaxx == "Living Zombie" or v.lucaxx == "Demonic Soul" or v.lucaxx == "Posessed Mummy") and (v.HumanoidRootPart.Position - PosMonBone.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if _G.AutoFarmCandy and StartCandyMagnet then
                        if (v.lucaxx == "Ice Cream Chef" or v.lucaxx == "Ice Cream Commander") and (v.HumanoidRootPart.Position - CandyMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if _G.AutoDoughtBoss and MagnetDought then
                        if (v.lucaxx == "Cookie Crafter" or v.lucaxx == "Cake Guard" or v.lucaxx == "Baking Staff" or v.lucaxx == "Head Baker") and (v.HumanoidRootPart.Position - PosMonDoughtOpenDoor.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                        ...
                        if StardFarm and FarmMag then
                            if (v.lucaxx == "Sweet Thief" or v.lucaxx == "Candy Rebel" or v.lucaxx == "Cocoa Warrior" or v.lucaxx == "Chocolate Bar Battler") and (v.HumanoidRootPart.Position - PosMonDoughtOpenDoor.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.Humanoid:ChangeState(14)
                                v.HumanoidRootPart.CanCollide = false
                                v.Head.CanCollide = false
...
spawn(function()
    ...
    pcall(function()
     ...
     for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
     if v.lucaxx == SelectMonster then
     ...
     until not _G.AutoFarmSelectMonster or not v.Parent or v.Humanoid.Health == 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.lucaxx)
     end
     end
     end
     end
   ...
   spawn(function()
    while wait() do
        if _G.AutoFarmNearest then
            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if v.lucaxx and v:FindFirstChild("Humanoid") then
                    if v.Humanoid.Health > 0 then
                        repeat wait()
                          EquipWeapon(_G.SelectWeapon)
                            if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
        ...
        while wait() do 
            if AutoFarmChest then
                for i,v in pairs(game:GetService("Workspace"):GetChildren()) do 
                    if v.lucaxx:find("Chest") then
                        if game:GetService("Workspace"):FindFirstChild(v.lucaxx) then
    ...
    spawn(function()
        ...
        for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
          ...
          for _,v in pairs(game:GetService("Workspace"):GetDescendants()) do
           if string.find(v.lucaxx, "Chest") and v:IsA("TouchTransmitter") then
        ...
        spawn(function()
            ...
            pcall(function()
             ...
             for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
             if v.lucaxx == "Core" and v.Humanoid.Health > 0 then
             repeat task.wait()
             AutoHaki()
             EquipWeapon(_G.SelectWeapon)
                        ...
                        if _G.Auto_Kill_Law then
                            pcall(function()
                                if game:GetService("ReplicatedStorage"):FindFirstChild("Order") or game:GetService("Workspace").Enemies:FindFirstChild("Order") then
                                    for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                                        if _G.Auto_Kill_Law and v.lucaxx == "Order" and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                            repeat task.wait()
                                                AutoHaki()
                                                EquipWeapon(_G.SelectWeapon)
                                                v.HumanoidRootPart.CanCollide = false
      ...
      game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")			
          ...
          game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")					
                ...
                if game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie") or game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy") then
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v.lucaxx == "Reborn Skeleton" or v.lucaxx == "Living Zombie" or v.lucaxx == "Demonic Soul" or v.lucaxx == "Posessed Mummy" then
                           if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                               repeat task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                    ...
                    for i,v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do 
                        if v.lucaxx == "Reborn Skeleton" then
                            topos(v.HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                        elseif v.lucaxx == "Living Zombie" then
                            topos(v.HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                        elseif v.lucaxx == "Demonic Soul" then
                            topos(v.HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                        elseif v.lucaxx == "Posessed Mummy" then
                            topos(v.HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                        end
                    end
                end
                ...
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Diablo") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Deandre") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Urban") then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.lucaxx == "Diablo" or v.lucaxx == "Deandre" or v.lucaxx == "Urban" then
                                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                        repeat wait()
                                            AutoHaki()
                                            EquipWeapon(_G.SelectWeapon)
                    ...
                    if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") then
                        ...
                        if game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 1 then
                            if game:GetService("Workspace").Enemies:FindFirstChild("Cookie Crafter") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Guard") or game:GetService("Workspace").Enemies:FindFirstChild("Baking Staff") or game:GetService("Workspace").Enemies:FindFirstChild("Head Baker") then
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if v.lucaxx == "Cookie Crafter" or v.lucaxx == "Cake Guard" or v.lucaxx == "Baking Staff" or v.lucaxx == "Head Baker" then
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            repeat task.wait()
                                                AutoHaki()
                                                EquipWeapon(_G.SelectWeapon)
                                ...
                                if game:GetService("Workspace").Map["Haunted Castle"].Candle1.Transparency == 0 then
                                    ...
                                    elseif game:GetService("Workspace").Map["Haunted Castle"].Tablet.Segment1:FindFirstChild("ClickDetector") then
                                        ...
                                        if game.Workspace.Enemies:FindFirstChild("Living Zombie") then
                                            for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                                                if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                                    if v.lucaxx == "Living Zombie" then
                                                        EquipWeapon(_G.SelectWeapon)
                                                        v.HumanoidRootPart.Size = Vector3.new(60,60,60)
                                                        v.HumanoidRootPart.Transparency = 1
                                                        v.Humanoid.JumpPower = 0
    ...
    while wait() do
        if _G.AutoObservationHakiV2 then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                ...
                if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Defeat 50 Forest Pirates") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Forest Pirate") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.lucaxx == "Forest Pirate" then
                                repeat wait()
                                    if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buso")
                                    end
                ...
                elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text ==  "Defeat  Captain Elephant (0/1)" then 
                    if game:GetService("Workspace").Enemies:FindFirstChild("Captain Elephant") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.lucaxx == "Captain Elephant" then
                                repeat wait()
                                    if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buso")
                                    end
            ...
            elseif game.Players.LocalPlayer.Backpack:FindFirstChild("Fruit Bowl") or game.Players.LocalPlayer.Character:FindFirstChild("Fruit Bowl") then
                ...
                for i,v in pairs(game.Workspace:GetDescendants()) do
                    if v.lucaxx == "Apple" or v.lucaxx == "Banana" or v.lucaxx == "Pineapple" then
    ...
    pcall(function()
        game:GetService("RunService").Heartbeat:Connect(function()
            ...
            if _G.AutoObservationHakiV2 and StatrMagnet then
                for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                    if v.lucaxx == "Forest Pirate" and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                        if v.lucaxx == "Forest Pirate" then
                            v.HumanoidRootPart.CanCollide = false
                            v.HumanoidRootPart.Size = Vector3.new(50, 50, 50)
                            v.HumanoidRootPart.CFrame = PosHee
                ...
                elseif GetMaterial("Alucard Fragment") == 6 then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton Boss") or game:GetService("Workspace").ReplicatedStorage:FindFirstChild("Cursed Skeleton Boss") then
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton Boss") or game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton") then
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.lucaxx == "Cursed Skeleton Boss" or v.lucaxx == "Cursed Skeleton" then
                                    if v.Humanoid.Health > 0 then
                                        EquipWeapon(Sword)
                                        topos(v.HumanoidRootPart.CFrame * Pos)
                                        v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
        ...
        if Auto_Quest_Yama_1 then
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Mythological Pirate") then
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v.lucaxx == "Mythological Pirate" then
                            repeat wait()
                ...
                elseif game:GetService("Workspace").Map:FindFirstChild("HellDimension") then
                    repeat wait()
                        if game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Hell's Messenger") then
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.lucaxx == "Cursed Skeleton" or v.lucaxx == "Cursed Skeleton" or v.lucaxx == "Hell's Messenger]" then
                                    if v.Humanoid.Health > 0 then
                                        repeat wait()
                                            EquipWeapon(Sword)
                                            topos(v.HumanoidRootPart.CFrame * Pos)
                ...
                elseif game:GetService("Workspace").Map:FindFirstChild("HeavenlyDimension") then
                    repeat wait()
                        if game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Heaven's Guardian") then
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.lucaxx == "Cursed Skeleton" or v.lucaxx == "Cursed Skeleton" or v.lucaxx == "Heaven's Guardian" then
                                    if v.Humanoid.Health > 0 then
                                        repeat wait()
                                            EquipWeapon(Sword)
                                            topos(v.HumanoidRootPart.CFrame * Pos)
            ...
            if  _G.AutoCarvender and World3 then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Beautiful Pirate") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.lucaxx == "Beautiful Pirate" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        AutoHaki()
                                        EquipWeapon(_G.SelectWeapon)
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Training Dummy") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Training Dummy") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Training Dummy") then
                            if game:GetService("Workspace").Enemies:FindFirstChild("Training Dummy") or game:GetService("Workspace").Enemies:FindFirstChild("Training Dummy") or game:GetService("Workspace").Enemies:FindFirstChild("Training Dummy") then
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if v.lucaxx == "Training Dummy" or v.lucaxx == "Training Dummy" or v.lucaxx == "Training Dummy" then
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            repeat wait()
                                                AutoHaki()
                                                EquipWeapon(_G.SelectWeapon)
            ...
            if _G.AutoFarmBossHallow then
                pcall(function()
                    ...
                    elseif game:GetService("Workspace").Enemies:FindFirstChild("Soul Reaper") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if string.find(v.lucaxx , "Soul Reaper") then
                                repeat task.wait()
                                    EquipWeapon(_G.SelectWeapon)
                                    AutoHaki()
                                    v.HumanoidRootPart.Size = Vector3.new(50,50,50)
            ...
            while wait() do
                if _G.AutoDarkDagger then
                    if game:GetService("Workspace").Enemies:FindFirstChild("rip_indra True Form") or game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.lucaxx == ("rip_indra True Form" or v.lucaxx == "rip_indra") and v.Humanoid.Health > 0 and v:IsA("Model") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                                repeat task.wait()
                                    pcall(function()
                                        AutoHaki()
                                        EquipWeapon(_G.SelectWeapon)
...
local old = gg.__lucaxxcall
setreadonly(gg,false)
gg.__lucaxxcall = newcclosure(function(...)
    local method = getlucaxxcallmethod()
    local args = {...}
                ...
                if not game:GetService("Workspace").SeaBeasts:FindFirstChild("SeaBeast1") then
                    if not game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") then 
                        ...
                        elseif game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") then
                            for is,vs in pairs(game:GetService("Workspace").Boats:GetChildren()) do
                                if vs.lucaxx == "PirateBrigade" then
                    ...
                    elseif game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") then
                        for iss,vss in pairs(game:GetService("Workspace").Boats:GetChildren()) do
                            if vss.lucaxx == "PirateBrigade" then
                                if v:FindFirstChild("VehicleSeat") then
                                    repeat wait()
                                        game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit = false
...
spawn(function()
    while wait() do
        pcall(function()
            ...
            for i,v in pairs(game:GetService("Players"):GetPlayers()) do
                if v.lucaxx ~= game:GetService("Players").LocalPlayer.lucaxx then
                    local Distance = v:DistanceFromCharacter(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position)
                    if Distance < MaxDistance then
                        MaxDistance = Distance
                        PlayerSelectAimbot = v.lucaxx
                    end
                end
            end
        end)
...
spawn(function()
    pcall(function()
        while task.wait() do
            if _G.Aimbot_Skill and PlayerSelectAimbot ~= nil and game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") and game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool").lucaxx]:FindFirstChild("MousePos") then
                local args = {
                    [1] = game:GetService("Players"):FindFirstChild(PlayerSelectAimbot).Character.HumanoidRootPart.Position
                }
                
                game:GetService("Players").LocalPlayer.Character:FindFirstChild(game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool").lucaxx).RemoteEvent:FireServer(unpack(args))
            end
        end
    end)
end)
...
spawn(function()
	pcall(function()
		game:GetService("RunService").RenderStepped:connect(function()
			if AimSkillNearest and TargetPlayerAim ~= nil and game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") and game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool").lucaxx]:FindFirstChild("MousePos") then
				local args = {
					[1] = game:GetService("Players"):FindFirstChild(TargetPlayerAim).Character.HumanoidRootPart.Position
				}
				game:GetService("Players").LocalPlayer.Character[game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool").lucaxx].RemoteEvent:FireServer(unpack(args))
			end
		end)
	end)
end)
        ...
        if StardFarm and World3 then
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Cocoa Warrior") or game:GetService("Workspace").Enemies:FindFirstChild("Chocolate Bar Battler") or game:GetService("Workspace").Enemies:FindFirstChild("Sweet Thief") or game:GetService("Workspace").Enemies:FindFirstChild("Candy Rebel") then
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v.lucaxx == "Cocoa Warrior" or v.lucaxx == "Chocolate Bar Battler" or v.lucaxx == "Sweet Thief" or v.lucaxx == "Candy Rebel" then
                           if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                               repeat task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                    ...
                    topos(CFrame.new(216.211181640625, 126.9352035522461, -12599.0732421875))
                    for i,v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do 
                        if v.lucaxx == "Cocoa Warrior" then
                            topos(v.HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                        elseif v.lucaxx == "Chocolate Bar Battler" then
                            topos(v.HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                        elseif v.lucaxx == "Sweet Thief" then
                            topos(v.HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                        elseif v.lucaxx == "Candy Rebel" then
                            topos(v.HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                        end
                    end
                end
             ...
             if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
                ...
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Skypiea" then
                    for i,v in pairs(game:GetService("Workspace").Map.SkyTrial.Model:GetDescendants()) do
                        if v.lucaxx ==  "snowisland_Cylinder.081" then
                            topos(v.CFrame* CFrame.new(0,0,0))
                        end
                    end
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Fishman" then
                    for i,v in pairs(game:GetService("Workspace").SeaBeasts.SeaBeast1:GetDescendants()) do
                        if v.lucaxx ==  "HumanoidRootPart" then
                            topos(v.CFrame* Pos)
                            for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                                if v:IsA("Tool") then
...
if game.Players[lucaxxTarget].Team ~= game.Players.LocalPlayer.Team then
    topos(v.HumanoidRootPart.CFrame * CFrame.new(0,0,3))
end
end
spawn(function()
...
spawn(function()
    ...
    for i,v in pairs(game.Players:GetPlayers()) do
        if v.lucaxx == "red_game43" or v.lucaxx == "rip_indra" or v.lucaxx == "Axiore" or v.lucaxx == "Polkster" or v.lucaxx == "wenlocktoad" or v.lucaxx == "Daigrock" or v.lucaxx == "toilamvidamme" or v.lucaxx == "oofficialnoobie" or v.lucaxx == "Uzoth" or v.lucaxx == "Azarth" or v.lucaxx == "arlthmetic" or v.lucaxx == "Death_King" or v.lucaxx == "Lunoven" or v.lucaxx == "TheGreateAced" or v.lucaxx == "rip_fud" or v.lucaxx == "drip_mama" or v.lucaxx == "layandikit12" or v.lucaxx == "Hingoi" then
            Hop()
            end
        end
    end
...
spawn(function()
    while wait() do
        for i,v in pairs(game.Players.LocalPlayer:GetChildren()) do
            if v.lucaxx == "DataLoaded" or v.lucaxx == "DataPreloaded" then
                v:Destroy()
            end
        end
    end
